...
Open your automations file in any editor
...
Locate the correct body: > block for the seasonal email you want to update

Edit the HTML directly inside the YAML

Use single quotes ' inside HTML to avoid YAML parsing issues
